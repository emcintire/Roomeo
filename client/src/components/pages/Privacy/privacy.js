...
function Privacy() {
    return (
        <div> 
            ...
            <h2> 1. Limitations </h2>
            <p> Roomeo or its suppliers will not be hold accountable for any damages that will arise with the use or inability to use the materials on Roomeo, 
            ...
            <br></br>
            <h2> 2. Revisions and Errata </h2>
            <p> The materials appearing on Roomeo's Website may include technical, typographical, or photographic errors. Roomeo will not promise that any
            ...
            <br></br>
            <h2> 3. Links </h2>
            <p> Roomeo has not reviewed all of the sites linked to its Website and is not responsible for the contents of any such linked site. The presence of any link
